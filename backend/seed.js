...
const seedData = [
    { daysAgo: 1, bristolScale: 3, color: 'brown', notes: 'Felt bloated after eating bread.', aiAnalysis: 'Bloating may be related to gluten sensitivity.' },
    ...
    { daysAgo: 5, bristolScale: 4, color: 'green', notes: 'Normal day, no symptoms.', aiAnalysis: 'No significant concerns identified.' },
    ...
    { daysAgo: 8, bristolScale: 3, color: 'brown', notes: 'Felt bloated after eating bread.', aiAnalysis: 'Bloating may be related to gluten sensitivity.' },
    ...
    { daysAgo: 11, bristolScale: 6, color: 'yellow', notes: 'Diarrhea after eating spicy food.' , aiAnalysis: 'Diarrhea likely triggered by spicy food.'},
    { daysAgo: 12, bristolScale: 4, color: 'green', notes: 'Normal day, no symptoms.' },
    { daysAgo: 13, bristolScale: 2, color: 'black', notes: 'Very hard stool, felt uncomfortable.', aiAnalysis: 'Hard stool may indicate dehydration or low fiber intake.' },
    ...
    {daysAgo: 23, bristolScale: 3, color: 'brown', notes: 'Felt bloated after eating bread.', aiAnalysis: 'Bloating may be related to gluten sensitivity.' },
